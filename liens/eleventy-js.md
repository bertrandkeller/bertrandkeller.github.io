...
-   [Architecting data in Eleventy](https://dev.to/thegreengreek/architecting-data-in-eleventy-ek5)
-   [Eleventy: Paired Shortcodes and Markdown Rendering](http://dirtystylus.com/2020/06/16/eleventy-paired-shortcodes-and-markdown-rendering/)
...
-   [SofaConf 2020 - a technical write-up](https://clearleft.com/posts/sofaconf-2020-a-technical-write-up)
-   [Building and maintaining components from utility classes in Eleventy](https://chriskirknielsen.com/blog/building-and-maintaining-components-from-utility-classes-in-eleventy/)
...
-   [A Return to Progressive Enhancement with LitHtml and `11ty` (@eleven_ty)](https://medium.com/@bryan.wilhite/a-return-to-progressive-enhancement-with-lithtml-and-11ty-eleven-ty-e3e7e73fec9d)
...
-   [Beginner's Guide to Eleventy [Part I]](https://tatianamac.com/posts/beginner-eleventy-tutorial-parti/)
...
-   [Building a Static API with Eleventy](https://cobwwweb.com/building-static-api-eleventy)
-   [Embed everything](https://gfscott.com/embed-everything/)
-   [Eleventy contributors](https://www.zachleat.com/web/eleventy-contributors/)
-   <https://twitter.com/lasertarian/status/1279613206789599243>
-   [Building a Turnkey Fundraising Mini-site with Foxy and Eleventy](https://www.foxy.io/blog/building-a-turnkey-fundraising-mini-site-with-foxy-and-eleventy/)
-   <https://github.com/bymattlee/bymattlee-web-starter-files>
-   [Building and maintaining components from utility classes in Eleventy](https://chriskirknielsen.com/blog/building-and-maintaining-components-from-utility-classes-in-eleventy/)
-   [Add DuckDuckGo-powered search to your website](https://marcamos.com/journal/add-duckduckgo-search/)
