...
namespace :serve do
  ...
  task :dev do
    ...
    system "JEKYLL_ENV=development bundle exec jekyll clean && bundle exec jekyll s --config _config.yml,_config_dev.yml --profile --trace"
  end

  desc "Serve development Jekyll site locally"
  task :reload do
    puts "Starting up development Jekyll site server with livereload..."
    system "JEKYLL_ENV=development bundle exec jekyll clean && bundle exec jekyll s --config _config.yml,_config_dev.yml --profile --trace --livereload port:6000"
  end
